...
%Haberdash.Account.Developer{} = developer = insert(:developer, %{name: "Yukihiro Matsumoto", email: "yukihiromatsumoto@rubydev.com", owner_id: owner.id, password: "password"})
%Haberdash.Business.Franchise{} = franchise = insert(:franchise, %{name: "Soma Japanese Luxury Cuisine", owner_id: owner.id})
_products_list = insert_list(20, :product, %{franchise_id: franchise.id})

defmodule HaberdashWeb.ProductAccessoriesControllerTest do
  ...
  describe "create product_accessories" do
    ...
    test "renders product_accessories when data is valid", %{
      conn: conn,
      product: %Products{id: product_id} = product,
      accessories: %Accessories{id: accessories_id} = accessories
    } do
      conn =
        post(conn, Routes.product_accessories_path(conn, :create, product.id, accessories.id),
          product_accessories: @create_attrs
        )
    ...
    test "renders errors when data is invalid", %{
      ...
      assert_error_sent 404, fn ->
        post(
          conn,
          Routes.product_accessories_path(
            conn,
            :create,
            "25c0b427-84cf-43fa-905b-d1bcf4c577d9",
            "8c550503-c008-4794-b6b0-30e98de86c09"
          )
        )
      end
    end
  ...
  describe "delete product_accessories" do
    ...
    test "deletes chosen product_accessories", %{
      conn: conn,
      ...
      conn =
        delete(
          conn,
          Routes.product_accessories_path(conn, :delete, product_accessories.product_id),
      ...
      conn =
        get(
          ...
          Routes.product_accessories_path(
            conn,
            :show,
            product_accessories.product_id,
            product_accessories.accessories_id
          )
        )
